...
```{r}
### MS Dataset
var_pearson_1 <- get(load("../output/variance_pearson_1.RData"))
var_pearson_2 <- get(load("../output/variance_pearson_2.RData"))
var_spearman_1 <- get(load("../output/variance_spearman_1.RData"))
var_spearman_2 <- get(load("../output/variance_spearman_2.RData"))
...
### cluster
```{r}
pred_cluster<-cluster(train_1,test_1)
```
